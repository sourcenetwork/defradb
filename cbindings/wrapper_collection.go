...
func (c *Collection) ListIndexes(
	...
	if res.Status != 0 {
		return []client.IndexDescriptionStatus{}, errors.New(res.Error)
	}

	retRes, err := unmarshalResult[[]client.IndexDescriptionStatus](res.Value)
	if err != nil {
		return []client.IndexDescriptionStatus{}, err
	}
