...
extern Result P2PcollectionsFetch(uintptr_t nodePtr, char* versionIDs, char* timeoutStr, uintptr_t identity);
...
func (w *CWrapper) FetchCollections(ctx context.Context, versionIDs ...string) error {
	...
	res := ConvertAndFreeCResult(C.P2PcollectionsFetch(C.uintptr_t(w.handle), versions, cTimerStr, cIdentity))
