...
// ExtractProperties runs through the filter and returns a new filter with only the
// properties as keys.
// Different properties of the same relation object will be returned as elements of an array.
