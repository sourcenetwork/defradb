...
// ds.Datastore into its subcomponents Reader and Writer.
// Using this simplified interface means that both ds.Datastore
// and ds.Txn satisy the interface. Due to go-datastore#113 and
// go-datastore#114 ds.Txn no longer implements ds.Datastore
