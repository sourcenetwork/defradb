...
func (c *Client) JSValue() js.Value {
	return js.ValueOf(map[string]any{
		...
		"addPolicyWithDAC":               goji.Async(c.addPolicyWithDAC),
		"addActorRelationshipWithDAC":    goji.Async(c.addActorRelationshipWithDAC),
		"deleteActorRelationshipWithDAC": goji.Async(c.deleteActorRelationshipWithDAC),
