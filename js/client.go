...
func (c *Client) JSValue() js.Value {
	return js.ValueOf(map[string]any{
		...
		"getAACStatus":               goji.Async(c.getAACStatus),
		"reEnableAAC":                goji.Async(c.reEnableAAC),
		"disableAAC":                 goji.Async(c.disableAAC),
		"addAACActorRelationship":    goji.Async(c.addAACActorRelationship),
		"deleteAACActorRelationship": goji.Async(c.deleteAACActorRelationship),
