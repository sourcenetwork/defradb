...
func (db *innerDB) newCollection(desc client.CollectionDescription) (*collection, error) {
	if desc.Name == "" {
...
func (db *innerDB) CreateCollection(
	ctx context.Context,
	desc client.CollectionDescription,
...
func (db *innerDB) createCollectionTxn(
	ctx context.Context,
	txn datastore.Txn,
	desc client.CollectionDescription,
) (client.Collection, error) {
	...
	colSeq, err := db.outer.getSequence(ctx, txn, core.COLLECTION)
	if err != nil {
		return nil, err
	}
...
// applied.
func (db *innerDB) UpdateCollection(
	ctx context.Context,
	desc client.CollectionDescription,
) (client.Collection, error) {
	txn, err := db.getTxn(ctx, false)
	...
	col, err := db.updateCollectionTxn(ctx, txn, desc)
	if err != nil {
		return nil, err
	}
...
func (db *innerDB) updateCollectionTxn(
	ctx context.Context,
	txn datastore.Txn,
	desc client.CollectionDescription,
) (client.Collection, error) {
...
func (db *innerDB) ValidateUpdateCollection(
	ctx context.Context,
	...
	ok, err := db.validateUpdateCollectionTxn(ctx, txn, proposedDesc)
	if err != nil {
		return false, err
	}
...
func (db *innerDB) validateUpdateCollectionTxn(
	ctx context.Context,
	txn datastore.Txn,
	proposedDesc client.CollectionDescription,
) (bool, error) {
...
func (db *innerDB) getCollectionByVersionId(
	ctx context.Context,
	txn datastore.Txn,
...
func (db *innerDB) GetCollectionByName(ctx context.Context, name string) (client.Collection, error) {
	txn, err := db.getTxn(ctx, true)
	if err != nil {
		return nil, err
	}
	defer db.discardImplicitTxn(ctx, txn)
...
func (db *innerDB) GetCollectionBySchemaID(
	ctx context.Context,
	schemaID string,
) (client.Collection, error) {
	txn, err := db.getTxn(ctx, true)
...
func (db *innerDB) getCollectionBySchemaIDTxn(
	ctx context.Context,
	txn datastore.Txn,
	schemaID string,
) (client.Collection, error) {
...
func (db *innerDB) GetAllCollections(ctx context.Context) ([]client.Collection, error) {
	txn, err := db.getTxn(ctx, true)
	if err != nil {
		return nil, err
	}
...
func (db *innerDB) getAllCollectionsTxn(ctx context.Context, txn datastore.Txn) ([]client.Collection, error) {
