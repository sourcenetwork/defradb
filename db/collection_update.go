...
func (c *Collection) updateWithKey(ctx context.Context, txn client.Txn, key key.DocKey, updater interface{}, opts ...client.UpdateOpt) (*client.UpdateResult, error) {
...
func (c *Collection) updateWithKeys(ctx context.Context, txn client.Txn, keys []key.DocKey, updater interface{}, opts ...client.UpdateOpt) (*client.UpdateResult, error) {
	patch, err := parseUpdater(updater)
	if err != nil {
		return nil, err
	}
...
func (c *Collection) applyPatch(txn client.Txn, doc map[string]interface{}, patch []map[string]interface{}) error {
...
func (c *Collection) applyPatchOp(txn client.Txn, dockey string, field string, currentVal interface{}, patchOp map[string]interface{}) error {
	return nil
}

func (c *Collection) applyMerge(ctx context.Context, txn client.Txn, doc map[string]interface{}, merge map[string]interface{}) error {
...
func (c *Collection) getCollectionForPatchOpPath(txn client.Txn, path string) (col *Collection, isArray bool, err error) {
	return nil, false, nil
}

// getTargetKeyForPatchPath walks through the given doc and Patch path.
// It returns the
func (c *Collection) getTargetKeyForPatchPath(txn client.Txn, doc map[string]interface{}, path string) (string, error) {
