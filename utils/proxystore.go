...
func (p *ProxyStore) Get(key datastore.Key) (value []byte, err error) {
...
func (p *ProxyStore) Has(key datastore.Key) (exists bool, err error) {
	panic("not implemented") // TODO: Implement
}
...
func (p *ProxyStore) GetSize(key datastore.Key) (size int, err error) {
	panic("not implemented") // TODO: Implement
}
...
//
func (p *ProxyStore) Query(q query.Query) (query.Results, error) {
	panic("not implemented") // TODO: Implement
}
...
func (p *ProxyStore) Put(key datastore.Key, value []byte) error {
	panic("not implemented") // TODO: Implement
}

// Delete removes the value for given `key`. If the key is not in the
// datastore, this method returns no error.
func (p *ProxyStore) Delete(key datastore.Key) error {
	panic("not implemented") // TODO: Implement
}
...
func (p *ProxyStore) Sync(prefix datastore.Key) error {
	panic("not implemented") // TODO: Implement
}
