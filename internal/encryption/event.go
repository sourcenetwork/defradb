...
func NewRequestKeyMessage(docID string, cid cid.Cid, schemaRoot string) event.Message {
...
func NewKeyRetrievedMessage(docID string, cid cid.Cid, schemaRoot string, key []byte) event.Message {
