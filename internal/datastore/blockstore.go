...
// use it to decide whether to skip fetching, and history prune or the orphan sweep can
// delete a block at any time, so it is answered from the store rather than remembered.
