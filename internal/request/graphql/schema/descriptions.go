...
var (
	fieldKindToGQLType = map[client.FieldKind]gql.Type{
		...
		client.FieldKind_FLOAT32:                 gql.NewNonNull(schemaTypes.Float32),
		client.FieldKind_NILLABLE_FLOAT32:        schemaTypes.Float32,
		client.FieldKind_FLOAT32_ARRAY:           gql.NewList(gql.NewNonNull(schemaTypes.Float32)),
		client.FieldKind_NILLABLE_FLOAT32_ARRAY:  gql.NewList(schemaTypes.Float32),
		client.FieldKind_FLOAT64:                 gql.NewNonNull(schemaTypes.Float64),
		...
		client.FieldKind_DATETIME_ARRAY:          gql.NewList(gql.NewNonNull(gql.DateTime)),
		client.FieldKind_NILLABLE_DATETIME_ARRAY: gql.NewList(gql.DateTime),
