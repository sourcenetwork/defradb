...
// // MustGet returns the transaction from the context or panics.
// func MustGetDSTxn(ctx context.Context) *datastore.Txn {
...
func SetFromClient(ctx context.Context, txn client.Txn) context.Context {
	return context.WithValue(ctx, key{}, txn)
}

func MustGetFromClient(txn client.Txn) Txn {
