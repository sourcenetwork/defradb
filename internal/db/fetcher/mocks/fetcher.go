...
// Init provides a mock function with given fields: ctx, _a1, txn, index, col, fields, filter, docmapper, showDeleted
func (_m *Fetcher) Init(ctx context.Context, _a1 immutable.Option[identity.Identity], txn datastore.Txn, index immutable.Option[client.IndexDescription], col client.Collection, fields []client.FieldDefinition, filter *mapper.Filter, docmapper *core.DocumentMapping, showDeleted bool) error {
	ret := _m.Called(ctx, _a1, txn, index, col, fields, filter, docmapper, showDeleted)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, immutable.Option[identity.Identity], datastore.Txn, immutable.Option[client.IndexDescription], client.Collection, []client.FieldDefinition, *mapper.Filter, *core.DocumentMapping, bool) error); ok {
		r0 = rf(ctx, _a1, txn, index, col, fields, filter, docmapper, showDeleted)
	} else {
		r0 = ret.Error(0)
	}
...
//   - showDeleted bool
func (_e *Fetcher_Expecter) Init(ctx interface{}, _a1 interface{}, txn interface{}, index interface{}, col interface{}, fields interface{}, filter interface{}, docmapper interface{}, showDeleted interface{}) *Fetcher_Init_Call {
	return &Fetcher_Init_Call{Call: _e.mock.On("Init", ctx, _a1, txn, index, col, fields, filter, docmapper, showDeleted)}
}

func (_c *Fetcher_Init_Call) Run(run func(ctx context.Context, _a1 immutable.Option[identity.Identity], txn datastore.Txn, index immutable.Option[client.IndexDescription], col client.Collection, fields []client.FieldDefinition, filter *mapper.Filter, docmapper *core.DocumentMapping, showDeleted bool)) *Fetcher_Init_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(immutable.Option[identity.Identity]), args[2].(datastore.Txn), args[3].(immutable.Option[client.IndexDescription]), args[4].(client.Collection), args[5].([]client.FieldDefinition), args[6].(*mapper.Filter), args[7].(*core.DocumentMapping), args[8].(bool))
	})
	return _c
}
...
func (_c *Fetcher_Init_Call) RunAndReturn(run func(context.Context, immutable.Option[identity.Identity], datastore.Txn, immutable.Option[client.IndexDescription], client.Collection, []client.FieldDefinition, *mapper.Filter, *core.DocumentMapping, bool) error) *Fetcher_Init_Call {
	_c.Call.Return(run)
	return _c
}
