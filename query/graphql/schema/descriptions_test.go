					...
					Schema: client.SchemaDescription{
						...
						Fields: []client.FieldDescription{
							...
							},
							{
								...
								Typ:          client.NONE_CRDT,
								Schema:       "author",
								RelationType: client.Meta_Relation_ONE | client.Meta_Relation_ONEONE,
							},
							{
								Name:         "author_id",
								Kind:         client.FieldKind_DocKey,
					...
					Schema: client.SchemaDescription{
						...
						Fields: []client.FieldDescription{
							...
							},
							{
								...
								Typ:          client.NONE_CRDT,
								Schema:       "book",
								RelationType: client.Meta_Relation_ONE | client.Meta_Relation_ONEONE | client.Meta_Relation_Primary,
							},
							{
								Name:         "published_id",
								Kind:         client.FieldKind_DocKey,
					...
					Schema: client.SchemaDescription{
						...
						Fields: []client.FieldDescription{
							...
							},
							{
								...
								Typ:          client.NONE_CRDT,
								Schema:       "author",
								RelationType: client.Meta_Relation_ONE | client.Meta_Relation_ONEMANY | client.Meta_Relation_Primary,
							},
							{
								Name:         "author_id",
								Kind:         client.FieldKind_DocKey,
					...
					Schema: client.SchemaDescription{
						...
						Fields: []client.FieldDescription{
							...
							},
							{
								...
								Typ:          client.NONE_CRDT,
								Schema:       "book",
								RelationType: client.Meta_Relation_MANY | client.Meta_Relation_ONEMANY,
							},
						},
					},
					Indexes: testDefaultIndex,
