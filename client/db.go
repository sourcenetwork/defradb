...
type DB interface {
	...
	// and also tells us if admin acp is currently enabled or temporarily disabled.
	//
	// Note:
	// - If [StatusAACResult.IsConfigured] is true and [StatusAACResult.IsEnabled] is false,
	// then it means the admin acp is temporarily disabled.
