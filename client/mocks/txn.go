...
func (_mock *Txn) SyncBranchableCollection(ctx context.Context, collectionName string) error {
	ret := _mock.Called(ctx, collectionName)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) error); ok {
		r0 = returnFunc(ctx, collectionName)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
//   - ctx context.Context
//   - collectionName string
func (_e *Txn_Expecter) SyncBranchableCollection(ctx interface{}, collectionName interface{}) *Txn_SyncBranchableCollection_Call {
	return &Txn_SyncBranchableCollection_Call{Call: _e.mock.On("SyncBranchableCollection", ctx, collectionName)}
}

func (_c *Txn_SyncBranchableCollection_Call) Run(run func(ctx context.Context, collectionName string)) *Txn_SyncBranchableCollection_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Txn_SyncBranchableCollection_Call) RunAndReturn(run func(ctx context.Context, collectionName string) error) *Txn_SyncBranchableCollection_Call {
	_c.Call.Return(run)
	return _c
}
