...
func (_c *DB_Events_Call) Return(_a0 *events.Bus) *DB_Events_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *DB_Events_Call) RunAndReturn(run func() *events.Bus) *DB_Events_Call {
	_c.Call.Return(run)
	return _c
}
