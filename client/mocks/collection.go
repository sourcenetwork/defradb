...
func (_mock *Collection) PurgeByDocIDs(ctx context.Context, docIDs []string, pruneHistory bool) (*client.PurgeResult, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string, bool) (*client.PurgeResult, error)); ok {
		return returnFunc(ctx, docIDs, pruneHistory)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string, bool) *client.PurgeResult); ok {
		r0 = returnFunc(ctx, docIDs, pruneHistory)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, []string, bool) error); ok {
		r1 = returnFunc(ctx, docIDs, pruneHistory)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
//   - docIDs []string
//   - pruneHistory bool
func (_e *Collection_Expecter) PurgeByDocIDs(ctx interface{}, docIDs interface{}, pruneHistory interface{}) *Collection_PurgeByDocIDs_Call {
	return &Collection_PurgeByDocIDs_Call{Call: _e.mock.On("PurgeByDocIDs", ctx, docIDs, pruneHistory)}
}

func (_c *Collection_PurgeByDocIDs_Call) Run(run func(ctx context.Context, docIDs []string, pruneHistory bool)) *Collection_PurgeByDocIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Collection_PurgeByDocIDs_Call) Return(purgeResult *client.PurgeResult, err error) *Collection_PurgeByDocIDs_Call {
	_c.Call.Return(purgeResult, err)
	return _c
}

func (_c *Collection_PurgeByDocIDs_Call) RunAndReturn(run func(ctx context.Context, docIDs []string, pruneHistory bool) (*client.PurgeResult, error)) *Collection_PurgeByDocIDs_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - ctx context.Context
func (_e *Collection_Expecter) Truncate(ctx interface{}) *Collection_Truncate_Call {
	return &Collection_Truncate_Call{Call: _e.mock.On("Truncate", ctx)}
}

func (_c *Collection_Truncate_Call) Run(run func(ctx context.Context)) *Collection_Truncate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Collection_Truncate_Call) RunAndReturn(run func(ctx context.Context) error) *Collection_Truncate_Call {
	_c.Call.Return(run)
	return _c
}
