...
func (mDB *mockDBColError) GetAllCollections(context.Context, bool) ([]client.Collection, error) {
...
func (mDB *mockDBDocIDsError) GetAllCollections(context.Context, bool) ([]client.Collection, error) {
