...
func MakeAdminACPRelationshipAddCommand() *cobra.Command {
	const (
...
`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			addAACActorRelationshipResult, err := cliClient.AddAACActorRelationship(
				cmd.Context(),
				relationArg,
				targetActorArg,
			)
			...
			return writeJSON(cmd, addAACActorRelationshipResult)
		},
	}
