...
func MakeStartCommand() *cobra.Command {
	...
	err = viper.BindPFlag("datastore.store", cmd.Flags().Lookup("store"))
	if err != nil {
	...
	err = viper.BindPFlag("net.p2paddress", cmd.Flags().Lookup("p2paddr"))
	if err != nil {
	...
	err = viper.BindPFlag("net.tcpaddress", cmd.Flags().Lookup("tcpaddr"))
	if err != nil {
	...
	err = viper.BindPFlag("net.p2pdisabled", cmd.Flags().Lookup("no-p2p"))
	if err != nil {
