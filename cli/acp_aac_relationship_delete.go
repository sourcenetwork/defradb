...
func MakeAdminACPRelationshipDeleteCommand() *cobra.Command {
	const (
...
`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			deleteAACActorRelationshipResult, err := cliClient.DeleteAACActorRelationship(
				cmd.Context(),
				relationArg,
				targetActorArg,
			)
			...
			return writeJSON(cmd, deleteAACActorRelationshipResult)
		},
	}
