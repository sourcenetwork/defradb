...
const (
	...
	errEmptyCollectionSchema        string = "schema cannot be empty"
...
var (
	...
	ErrEmptyCollectionSchema            = errors.New(errEmptyCollectionSchema)
...
func NewErrFailedToReadCollectionFile(schemaFile string, inner error) error {
