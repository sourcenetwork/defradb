...
Manage (add, delete, or list) collection indexes on a DefraDB node.
...
* [defradb client index add](defradb_client_index_add.md)	 - Creates a secondary index on a collection's field(s)
