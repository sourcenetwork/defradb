...
* [defradb client encrypted-index list](defradb_client_encrypted-index_list.md)	 - Shows the list encrypted indexes in the database or for a specific collection
