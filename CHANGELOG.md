...
To get a full outline of the changes, we invite you to review the official changelog below. This release does include a Breaking Change to existing v0.20.x databases. If you need help migrating an existing deployment, reach out at [hello@source.network](mailto:hello@source.network) or join our Discord at https://source.network/discord.

### Features

* Serverless client side schema generation ([#4263](https://github.com/sourcenetwork/defradb/issues/4263))
* Gate sync collection versions op with NAC ([#4507](https://github.com/sourcenetwork/defradb/issues/4507))
* Require dev-mode for import/export ([#4569](https://github.com/sourcenetwork/defradb/issues/4569))
* Gate sync documents op with NAC ([#4528](https://github.com/sourcenetwork/defradb/issues/4528))
* Gate encrypted index delete op with NAC ([#4534](https://github.com/sourcenetwork/defradb/issues/4534))
* Gate list encrypted indexes op with NAC ([#4540](https://github.com/sourcenetwork/defradb/issues/4540))
* Gate encrypted index create op with NAC ([#4532](https://github.com/sourcenetwork/defradb/issues/4532))
* Gate migration set op with NAC ([#4530](https://github.com/sourcenetwork/defradb/issues/4530))
* Gate SyncBranchableCollection with NAC ([#4522](https://github.com/sourcenetwork/defradb/issues/4522))
* Consolidate node options ([#4501](https://github.com/sourcenetwork/defradb/issues/4501))
* Gate view add op with NAC ([#4504](https://github.com/sourcenetwork/defradb/issues/4504))
* Gate view refresh op with NAC ([#4505](https://github.com/sourcenetwork/defradb/issues/4505))
* Add support for `_eq` and  `_neq` to inline scalar arrays ([#4293](https://github.com/sourcenetwork/defradb/issues/4293))
* Make explain recursive for nested joins ([#4471](https://github.com/sourcenetwork/defradb/issues/4471))
* Introduce options package for public methods ([#4335](https://github.com/sourcenetwork/defradb/issues/4335))
* Gate active peers op with NAC ([#4499](https://github.com/sourcenetwork/defradb/issues/4499))
* Gate lens add op with NAC ([#4492](https://github.com/sourcenetwork/defradb/issues/4492))
* Gate lens list op with NAC ([#4491](https://github.com/sourcenetwork/defradb/issues/4491))
* Gate PeerInfo with NAC & Add Context ([#4282](https://github.com/sourcenetwork/defradb/issues/4282))
* Improve NotAuthorizedToPerformOperation errors ([#4373](https://github.com/sourcenetwork/defradb/issues/4373))
* LevelDB store ([#4298](https://github.com/sourcenetwork/defradb/issues/4298))
* Add optional file flags for cli view add command ([#3314](https://github.com/sourcenetwork/defradb/issues/3314))
* Accept arrays of CIDs for GQL queries ([#4571](https://github.com/sourcenetwork/defradb/issues/4571))
* Change GQL commits.docId param to list ([#4578](https://github.com/sourcenetwork/defradb/issues/4578))
* Add keyring overwrite protection ([#4290](https://github.com/sourcenetwork/defradb/issues/4290))
* Remove _latestCommits ([#4169](https://github.com/sourcenetwork/defradb/issues/4169))
* Add collection truncate ([#4326](https://github.com/sourcenetwork/defradb/issues/4326))
* Rename foreign keys to _<rel>ID ([#4274](https://github.com/sourcenetwork/defradb/issues/4274))
* Add optional health check to setup wizard ([#4313](https://github.com/sourcenetwork/defradb/issues/4313))
* Rename schema version id ([#4299](https://github.com/sourcenetwork/defradb/issues/4299))
* Introduce setup wizard ([#4273](https://github.com/sourcenetwork/defradb/issues/4273))
* Refresh materialized views on create ([#4379](https://github.com/sourcenetwork/defradb/issues/4379))
* Create view from cid ([#4278](https://github.com/sourcenetwork/defradb/issues/4278))
* Sync branchable collection ([#4188](https://github.com/sourcenetwork/defradb/issues/4188))
* Add methods AddLens and ListLenses ([#4264](https://github.com/sourcenetwork/defradb/issues/4264))
* Create unique index for 1-to-1 relations ([#4218](https://github.com/sourcenetwork/defradb/issues/4218))
* Push topic peer events to event bus ([#4247](https://github.com/sourcenetwork/defradb/issues/4247))
* Upgrade CommitLink with full Commit object support ([#4217](https://github.com/sourcenetwork/defradb/issues/4217))
* Allow C binding view functions to take in identities ([#4241](https://github.com/sourcenetwork/defradb/issues/4241))
* Support UTC_NOW as a DateTime value ([#4210](https://github.com/sourcenetwork/defradb/issues/4210))
* Add _in/_nin to _commits filter ([#4230](https://github.com/sourcenetwork/defradb/issues/4230))
* Enable filter on commit's fieldName ([#4216](https://github.com/sourcenetwork/defradb/issues/4216))
* Add ability to bypass DAC for performance ([#4115](https://github.com/sourcenetwork/defradb/issues/4115))
* Add ActivePeers function ([#4206](https://github.com/sourcenetwork/defradb/issues/4206))
* Add secp256r1 support ([#4202](https://github.com/sourcenetwork/defradb/issues/4202))
* Allow deletion of collections via PatchCollection ([#4200](https://github.com/sourcenetwork/defradb/issues/4200))
* **i:** Remove blocks when truncating ([#4365](https://github.com/sourcenetwork/defradb/issues/4365))

### Fixes

* Null json index panic ([#4338](https://github.com/sourcenetwork/defradb/issues/4338))
* Encode identity as hex in commit query ([#4104](https://github.com/sourcenetwork/defradb/issues/4104))
* Lens file reading in collection patch command ([#4564](https://github.com/sourcenetwork/defradb/issues/4564))
* Propagate unmarshal errors ([#4563](https://github.com/sourcenetwork/defradb/issues/4563))
* Only scan relevant doc-commits in commit queries ([#4512](https://github.com/sourcenetwork/defradb/issues/4512))
* Make CBinding NewNode attach identity to context ([#4519](https://github.com/sourcenetwork/defradb/issues/4519))
* Make Wazero the lens runtime for C bindings ([#4524](https://github.com/sourcenetwork/defradb/issues/4524))
* Remove extraneous comment in C Binding header ([#4481](https://github.com/sourcenetwork/defradb/issues/4481))
* Async context use ([#4455](https://github.com/sourcenetwork/defradb/issues/4455))
* Field short ID retrieval ([#4457](https://github.com/sourcenetwork/defradb/issues/4457))
* Flaky SourceHub tests ([#4416](https://github.com/sourcenetwork/defradb/issues/4416))
* Prevent database operations after close ([#4435](https://github.com/sourcenetwork/defradb/issues/4435))
* Windows build ([#4124](https://github.com/sourcenetwork/defradb/issues/4124))
* Reject index on accumulated CRDT fields ([#4447](https://github.com/sourcenetwork/defradb/issues/4447))
* Ensure commit subscriptions filter by docID ([#4436](https://github.com/sourcenetwork/defradb/issues/4436))
* Aggregates on indexed relations ([#4438](https://github.com/sourcenetwork/defradb/issues/4438))
* Secondary index handle neq and nin filters ([#4433](https://github.com/sourcenetwork/defradb/issues/4433))
* Test matcher subscription bug ([#4429](https://github.com/sourcenetwork/defradb/issues/4429))
* Skip index for complex JSON filter values ([#4426](https://github.com/sourcenetwork/defradb/issues/4426))
* Use index with _or conditions on same field ([#4423](https://github.com/sourcenetwork/defradb/issues/4423))
* Index on JSON _geq and _leq null filter ops ([#4415](https://github.com/sourcenetwork/defradb/issues/4415))
* Grouping by indexed field ([#4409](https://github.com/sourcenetwork/defradb/issues/4409))
* Filter on top-level indexed JSON field ([#4406](https://github.com/sourcenetwork/defradb/issues/4406))
* Correctly refresh views with already cached data ([#4382](https://github.com/sourcenetwork/defradb/issues/4382))
* Add missing return after successful merge execution ([#4356](https://github.com/sourcenetwork/defradb/issues/4356))
* Secondary index on sub query filter ([#4344](https://github.com/sourcenetwork/defradb/issues/4344))
* Update to WebTransport 0.10.0 ([#4589](https://github.com/sourcenetwork/defradb/issues/4589))
* Index-based order for nested queries ([#4342](https://github.com/sourcenetwork/defradb/issues/4342))
* Handle _version property in time travel queries ([#4147](https://github.com/sourcenetwork/defradb/issues/4147))
* Suppress error log on timeout in pubsub handler ([#4292](https://github.com/sourcenetwork/defradb/issues/4292))
* Unify docID type to ID in graphql schema ([#4291](https://github.com/sourcenetwork/defradb/issues/4291))
* On doc-sync wait for docs from all peers ([#4296](https://github.com/sourcenetwork/defradb/issues/4296))
* Connect peers with retries in tests ([#4289](https://github.com/sourcenetwork/defradb/issues/4289))
* Migrations with filtering ([#4254](https://github.com/sourcenetwork/defradb/issues/4254))
* Make resolution of UTC_NOW the same across transaction ([#4248](https://github.com/sourcenetwork/defradb/issues/4248))
* Sync DAG ([#4270](https://github.com/sourcenetwork/defradb/issues/4270))
* Ordering by multiple fields ([#4238](https://github.com/sourcenetwork/defradb/issues/4238))
* Sec. side relation via patch and AddSchema ([#4221](https://github.com/sourcenetwork/defradb/issues/4221))
* Remove enabling NAC option from config ([#4225](https://github.com/sourcenetwork/defradb/issues/4225))
* Introspection error and badly formatted GQL types ([#4175](https://github.com/sourcenetwork/defradb/issues/4175))
* Lint issues in gendocs_test.go ([#4203](https://github.com/sourcenetwork/defradb/issues/4203))
* Make node apply a default store path ([#4186](https://github.com/sourcenetwork/defradb/issues/4186))
* Mutation of branchable collection ([#4187](https://github.com/sourcenetwork/defradb/issues/4187))
* Handle _version alongside type joins ([#4174](https://github.com/sourcenetwork/defradb/issues/4174))
* Bump sonic to version 14.2 with Go 1.24 support ([#4167](https://github.com/sourcenetwork/defradb/issues/4167))
* Solve cyclic-dependency stack overflow bug ([#4332](https://github.com/sourcenetwork/defradb/issues/4332))
* Lens-migrations-aware secondary indexes ([#4114](https://github.com/sourcenetwork/defradb/issues/4114))
* Handle queries with _version prop and order param ([#4146](https://github.com/sourcenetwork/defradb/issues/4146))
* Return error from CLI when collection not found ([#4592](https://github.com/sourcenetwork/defradb/issues/4592))
* Fix identity-related bugs in c bindings ([#4145](https://github.com/sourcenetwork/defradb/issues/4145))
* Set FieldID when syncing collections ([#4142](https://github.com/sourcenetwork/defradb/issues/4142))
* Allow Lenses to pull docs from source ([#4143](https://github.com/sourcenetwork/defradb/issues/4143))
* Glibc error with Docker container ([#4129](https://github.com/sourcenetwork/defradb/issues/4129))

### Documentation

* Add build requirements documentation ([#4224](https://github.com/sourcenetwork/defradb/issues/4224))
* Switch git clone URL to use https ([#4177](https://github.com/sourcenetwork/defradb/issues/4177))

### Performance

* Skip value fetch when only keys are requested ([#4372](https://github.com/sourcenetwork/defradb/issues/4372))

### Refactoring

* Rename encrypted index add to encrypted index new ([#4604](https://github.com/sourcenetwork/defradb/issues/4604))
* Rename index add to index new ([#4605](https://github.com/sourcenetwork/defradb/issues/4605))
* Rename to have action verb first ([#4600](https://github.com/sourcenetwork/defradb/issues/4600))
* Rename txn create to txn new ([#4594](https://github.com/sourcenetwork/defradb/issues/4594))
* Rename 'Schema' to 'Collection' terminology ([#4591](https://github.com/sourcenetwork/defradb/issues/4591))
* Rename document-level cmds under collection api ([#4581](https://github.com/sourcenetwork/defradb/issues/4581))
* Remove GetAllDocIDs/docIDs from collection api ([#4579](https://github.com/sourcenetwork/defradb/issues/4579))
* Rename operations from `create` to `add` terminology ([#4561](https://github.com/sourcenetwork/defradb/issues/4561))
* Rename keyring commands ([#4560](https://github.com/sourcenetwork/defradb/issues/4560))
* Rename index commands ([#4555](https://github.com/sourcenetwork/defradb/issues/4555))
* Rename CreateEncryptedIndex ([#4553](https://github.com/sourcenetwork/defradb/issues/4553))
* Move identity context funcs to internal ([#4549](https://github.com/sourcenetwork/defradb/issues/4549))
* Rename GetCollectionsOptions.GetInactive ([#4543](https://github.com/sourcenetwork/defradb/issues/4543))
* Rename options enumerable ([#4527](https://github.com/sourcenetwork/defradb/issues/4527))
* Make P2P document names consistent ([#4469](https://github.com/sourcenetwork/defradb/issues/4469))
* Make P2P collection names consistent ([#4464](https://github.com/sourcenetwork/defradb/issues/4464))
* Rename certain GQL operators ([#4357](https://github.com/sourcenetwork/defradb/issues/4357))
* Update ACP Policy DSL ([#4237](https://github.com/sourcenetwork/defradb/issues/4237))
* Introduce collection lock system ([#4276](https://github.com/sourcenetwork/defradb/issues/4276))
* Replace string literals with constants ([#4301](https://github.com/sourcenetwork/defradb/issues/4301))
* Remove p2p transactions ([#4212](https://github.com/sourcenetwork/defradb/issues/4212))
* Wrap Datastore in key-typed wrapper ([#4242](https://github.com/sourcenetwork/defradb/issues/4242))
* Replace SE key collection root cid with short id ([#4226](https://github.com/sourcenetwork/defradb/issues/4226))
* KMS sync ordering ([#4214](https://github.com/sourcenetwork/defradb/issues/4214))
* Pass identity consistently in C binding functions ([#4180](https://github.com/sourcenetwork/defradb/issues/4180))
* Rename SyncCollections to SyncCollectionVersions ([#4183](https://github.com/sourcenetwork/defradb/issues/4183))

### Testing

* Enable marking tests as flaky ([#4582](https://github.com/sourcenetwork/defradb/issues/4582))
* Add truncate parallel test ([#4420](https://github.com/sourcenetwork/defradb/issues/4420))
* Add test for lensed views after restart ([#4445](https://github.com/sourcenetwork/defradb/issues/4445))
* Add tests for truncation of views ([#4432](https://github.com/sourcenetwork/defradb/issues/4432))
* Migrate patch collection test action ([#4395](https://github.com/sourcenetwork/defradb/issues/4395))
* Migrate CreateDoc action to testo ([#4407](https://github.com/sourcenetwork/defradb/issues/4407))
* Migrate GetCollections test action to action package ([#4389](https://github.com/sourcenetwork/defradb/issues/4389))
* Introduce secondary index test multiplier ([#4387](https://github.com/sourcenetwork/defradb/issues/4387))
* Migrate request test actions to new framework ([#4359](https://github.com/sourcenetwork/defradb/issues/4359))
* Migrate view test actions to action package ([#4368](https://github.com/sourcenetwork/defradb/issues/4368))
* Migrate index related actions to new framework ([#4349](https://github.com/sourcenetwork/defradb/issues/4349))
* Enable all TestSignature tests for C client ([#4166](https://github.com/sourcenetwork/defradb/issues/4166))

### Chore

* Add coderabbit config ([#4440](https://github.com/sourcenetwork/defradb/issues/4440))
* Update secp256r1 logic ([#4261](https://github.com/sourcenetwork/defradb/issues/4261))
* Rename GraphQL Aggregates ([#4496](https://github.com/sourcenetwork/defradb/issues/4496))
* Make P2P replicator names consistent ([#4472](https://github.com/sourcenetwork/defradb/issues/4472))
* Remove wasmer dependency ([#4449](https://github.com/sourcenetwork/defradb/issues/4449))
* Use operator constants in schema definitions ([#4448](https://github.com/sourcenetwork/defradb/issues/4448))
* Rename P2P commands from Create to Add ([#4544](https://github.com/sourcenetwork/defradb/issues/4544))
* Expand git version support for Makefile build version ([#4131](https://github.com/sourcenetwork/defradb/issues/4131))
* Improve cli error messages ([#4477](https://github.com/sourcenetwork/defradb/issues/4477))
* Utilize default db path if blank string passed in ([#4173](https://github.com/sourcenetwork/defradb/issues/4173))
* Make C bindings ViewRefresh take C.CollectionOptions ([#4239](https://github.com/sourcenetwork/defradb/issues/4239))
* Bump to GoLang v1.25 ([#4260](https://github.com/sourcenetwork/defradb/issues/4260))

### Bot

* Update dependencies (bulk dependabot PRs) 03-03-2026 ([#4606](https://github.com/sourcenetwork/defradb/issues/4606))
* Update dependencies (bulk dependabot PRs) 17-02-2026 ([#4537](https://github.com/sourcenetwork/defradb/issues/4537))
* Update dependencies (bulk dependabot PRs) 2026-02-02 ([#4462](https://github.com/sourcenetwork/defradb/issues/4462))
* Update dependencies (bulk dependabot PRs) 2026-01-26 ([#4417](https://github.com/sourcenetwork/defradb/issues/4417))
* Bump github.com/cometbft/cometbft from 0.38.19 to 0.38.21 ([#4408](https://github.com/sourcenetwork/defradb/issues/4408))
* Update dependencies (bulk dependabot PRs) 19-01-2026 ([#4366](https://github.com/sourcenetwork/defradb/issues/4366))
* Update dependencies (bulk dependabot PRs) 18-01-2026 ([#4360](https://github.com/sourcenetwork/defradb/issues/4360))
* Update dependencies (bulk dependabot PRs) 2026-01-06 ([#4312](https://github.com/sourcenetwork/defradb/issues/4312))
* Update dependencies (bulk dependabot PRs) 2025-11-28 ([#4220](https://github.com/sourcenetwork/defradb/issues/4220))
