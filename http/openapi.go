...
func init() {
	...
	// add common responses and params so we can reference them
	OpenApiSpec.Components.Responses["success"] = &openapi3.ResponseRef{Value: successResponse}
	OpenApiSpec.Components.Responses["error"] = &openapi3.ResponseRef{Value: errorResponse}
	OpenApiSpec.Components.Parameters["txn"] = &openapi3.ParameterRef{Value: txnHeaderParam}
