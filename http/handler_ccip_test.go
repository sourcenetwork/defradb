...
func TestCCIPGet_WithValidData(t *testing.T) {
	...
	url := "http://localhost:9181/api/v1/ccip/" + path.Join(sender, data)
...
func TestCCIPPost_WithValidData(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "http://localhost:9181/api/v1/ccip", bytes.NewBuffer(body))
	rec := httptest.NewRecorder()
...
func TestCCIPPost_WithInvalidBody(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "http://localhost:9181/api/v1/ccip", nil)
	rec := httptest.NewRecorder()
