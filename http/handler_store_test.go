...
func TestExecRequest_WithValidQuery_OmitsErrors(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "http://localhost:9181/api/v1/graphql", bytes.NewBuffer(body))
...
func TestExecRequest_HttpGet_WithOperationName(t *testing.T) {
	...
	endpointURL := "http://localhost:9181/api/v1/graphql?query=" + encodedQuery + "&operationName=" + encodedOperationName
...
func TestExecRequest_HttpGet_WithVariables(t *testing.T) {
	...
	endpointURL := "http://localhost:9181/api/v1/graphql?query=" + encodedQuery + "&operationName=" + encodedOperationName + "&variables=" + encodedVariables
