...
func NewHandler(db client.DB, opts ServerOptions) *Handler {
	...
	// map handler funcs to OpenAPI operation IDs
	operations := map[string]http.HandlerFunc{
		"new_transaction":            tx_handler.NewTxn,
		"new_concurrent_transaction": tx_handler.NewConcurrentTxn,
		"transaction_commit":         tx_handler.Commit,
		"transaction_discard":        tx_handler.Discard,
		"backup_export":              store_handler.BasicExport,
		"backup_import":              store_handler.BasicImport,
		"collection_describe":        store_handler.GetCollection,
		"collection_create":          collection_handler.Create,
		"collection_get":             collection_handler.Get,
		"collection_update":          collection_handler.Update,
		"collection_update_with":     collection_handler.UpdateWith,
		"collection_delete":          collection_handler.Delete,
		"collection_delete_with":     collection_handler.DeleteWith,
		"index_create":               collection_handler.CreateIndex,
		"index_drop":                 collection_handler.DropIndex,
		"index_list":                 collection_handler.GetIndexes,
		"lens_config":                lens_handler.Config,
		"lens_reload":                lens_handler.ReloadLenses,
		"lens_set_migration":         lens_handler.SetMigration,
		"lens_has_migration":         lens_handler.HasMigration,
		"lens_migrate_up":            lens_handler.MigrateUp,
		"lens_migrate_down":          lens_handler.MigrateDown,
		"peer_info":                  store_handler.PeerInfo,
		"peer_replicator_list":       store_handler.GetAllReplicators,
		"peer_replicator_set":        store_handler.SetReplicator,
		"peer_replicator_delete":     store_handler.DeleteReplicator,
		"peer_collection_list":       store_handler.GetAllP2PCollections,
		"peer_collection_add":        store_handler.AddP2PCollection,
		"peer_collection_remove":     store_handler.RemoveP2PCollection,
		"debug_dump":                 store_handler.PrintDump,
		"graphql_get":                store_handler.ExecRequest,
		"graphql_post":               store_handler.ExecRequest,
	}
	...
	router.Route("/api/"+Version, func(api chi.Router) {
		...
		for pattern, path := range OpenApiSpec.Paths {
			for method, op := range path.Operations() {
				api.Method(method, pattern, operations[op.OperationID])
			}
		}
