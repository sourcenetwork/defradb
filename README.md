...
DISCLAIMER: In this current *Alpha* stage, DefraDB doesn't offer access control or encryption of data, and the default configuration expose the database onto the external network.
