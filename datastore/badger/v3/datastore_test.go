...
func TestPutWithTTLOperation(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)

	err := s.PutWithTTL(ctx, testKey3, testValue3, time.Hour)
	require.NoError(t, err)
}

func TestPutWithTTLWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestSetTTLOperation(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)

	err := s.SetTTL(ctx, testKey2, time.Hour)
	require.NoError(t, err)
}

func TestSetTTLWithNonExistingKey(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)

	err := s.SetTTL(ctx, testKey3, time.Hour)
	require.ErrorIs(t, err, badger.ErrKeyNotFound)
}

func TestSetTTLWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestGetExpirationOperation(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)

	exp, err := s.GetExpiration(ctx, testKey2)
	require.NoError(t, err)
	require.Equal(t, time.Unix(0, 0), exp)
}

func TestGetExpirationOperationPreviouslySet(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
	...
	exp, err := s.GetExpiration(ctx, testKey2)
	require.NoError(t, err)
	require.Equal(t, expectedExp.Year(), exp.Year())
	require.Equal(t, expectedExp.Month(), exp.Month())
	require.Equal(t, expectedExp.Day(), exp.Day())
	require.Equal(t, expectedExp.Hour(), exp.Hour())
}

func TestGetExpirationWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
	...
	_, err = s.GetExpiration(ctx, testKey2)
	require.ErrorIs(t, err, ErrClosed)
}
...
func TestTxnCloseOperation(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestTxnWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestTxnSync(t *testing.T) {
	...
	err = tx.(*txn).Sync(ctx, testKey1)
	require.NoError(t, err)
}

func TestTxnSyncWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestTxnPutWithTTLOperation(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
	...
	err = tx.(*txn).PutWithTTL(ctx, testKey3, testValue3, time.Hour)
	require.NoError(t, err)
}

func TestTxnPutWithTTLWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestTxnSetTTLOperation(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
	...
	err = tx.(*txn).SetTTL(ctx, testKey2, time.Hour)
	require.NoError(t, err)
}

func TestTxnSetTTLWithNonExistingKey(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
	...
	err = tx.(*txn).SetTTL(ctx, testKey3, time.Hour)
	require.ErrorIs(t, err, badger.ErrKeyNotFound)
}

func TestTxnSetTTLWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestTxnGetExpirationOperation(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
	...
	exp, err := tx.(*txn).GetExpiration(ctx, testKey2)
	require.NoError(t, err)
	require.Equal(t, time.Unix(0, 0), exp)
}

func TestTxnGetExpirationOperationPreviouslySet(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
...
func TestTxnGetExpirationWithStoreClosed(t *testing.T) {
	ctx := context.Background()
	s := newLoadedDatastore(ctx, t)
	...
	_, err = tx.(*txn).GetExpiration(ctx, testKey2)
	require.ErrorIs(t, err, ErrClosed)
}
