	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: "expr of required permission=write is missing required relation=owner",
			},
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: fmt.Sprintf(
					"resource=users is missing required permission=write on policy=%s",
					policyIDOfInvalidDPI,
				),
			},
	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: "expr of required permission=write must start with required relation=owner",
			},
	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: "expr of required permission=write has invalid char after relation=owner",
			},
