	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: "expr of required permission=read is missing required relation=owner",
			},
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: fmt.Sprintf(
					"resource=users is missing required permission=read on policy=%s",
					policyIDOfInvalidDPI,
				),
			},
	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: "expr of required permission=read must start with required relation=owner",
			},
	...
	test := testUtils.TestCase{
		...
		Actions: []any{
			...
			testUtils.SchemaUpdate{
				...
				ExpectedError: "expr of required permission=read has invalid char after relation=owner",
			},
