...
func TestNAC_GatesIndexCreatePreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "node acp correctly gates index create operation (setup before nac), allow if authorized, otherwise error",
