...
func TestNAC_GatesIndexDropPreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "node acp correctly gates index drop operation (setup before nac), allow if authorized, otherwise error",
