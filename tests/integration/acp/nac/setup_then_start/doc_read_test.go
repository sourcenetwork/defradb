...
func TestNAC_GatesDocReadPreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "node acp correctly gates doc read operation (setup before nac), allow if authorized, otherwise error",
