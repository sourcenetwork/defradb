...
func TestNAC_GatesDocDeletePreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "node acp correctly gates doc delete operation (setup before nac), allow if authorized, otherwise error",
