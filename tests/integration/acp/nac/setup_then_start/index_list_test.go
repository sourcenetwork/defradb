...
func TestNAC_GatesIndexListPreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "node acp correctly gates index list operation (setup before nac), allow if authorized, otherwise error",
