...
func TestNAC_GatesDocumentAdd_AuthorizedIdentity_AllowAccess(t *testing.T) {
...
func TestNAC_GatesDocumentAdd_NoIdentity_NotAuthorizedError(t *testing.T) {
	test := testUtils.TestCase{
...
func TestNAC_GatesDocumentAdd_WrongIdentity_NotAuthorizedError(t *testing.T) {
	test := testUtils.TestCase{
		// todo: Investigate and test this behavior across all client types when implementing granular NAC permissions.
		// See: https://github.com/sourcenetwork/defradb/issues/4383
		Actions: []any{
