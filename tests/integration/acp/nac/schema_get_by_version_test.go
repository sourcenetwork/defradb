...
func TestNAC_GatesSchemaGetByVersion_AllowIfAuthorizedElseError(t *testing.T) {
	schemaVersionID := "bafkreia2jn5ecrhtvy4fravk6pm3wqiny46m7mqymvjkgat7xiqupgqoai"

	test := testUtils.TestCase{
		Description: "node acp correctly gates schema get by version operation, allow if authorized, otherwise error",
		Actions: []any{
