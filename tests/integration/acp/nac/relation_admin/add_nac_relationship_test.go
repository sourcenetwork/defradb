...
func TestNAC_AdminRelation_CanAddNACRelationship(t *testing.T) {
	test := testUtils.TestCase{
		Description: "NAC admin relation grants a user permission to add a NAC actor relationship.",
		Actions: []any{
			...
			testUtils.AddNACActorRelationship{
				...
				Relation:          "admin",
				ExpectedError:     testUtils.FormatExpectedErrorWithPermission(acpTypes.NodeAddNACRelationPerm),
			},
