...
func TestNAC_AdminRelation_CanDeleteP2PDocument(t *testing.T) {
	test := testUtils.TestCase{
		Description: "NAC admin relation grants a user permission to delete a P2P document subscription.",
		...
		Actions: []any{
			...
			testUtils.DeleteDocumentSubscription{
				...
				ExpectedError: testUtils.FormatExpectedErrorWithPermission(acpTypes.NodeDeleteP2PDocumentPerm),
			},
