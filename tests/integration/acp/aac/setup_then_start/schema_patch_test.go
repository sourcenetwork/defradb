...
func TestAAC_GatesSchemaPatchPreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "admin acp correctly gates schema patch operation (setup before aac), allow if authorized, otherwise error",
