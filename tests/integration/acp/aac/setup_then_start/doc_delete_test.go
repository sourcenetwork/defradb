...
func TestAAC_GatesDocDeletePreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "admin acp correctly gates doc delete operation (setup before aac), allow if authorized, otherwise error",
