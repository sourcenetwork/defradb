...
func TestAAC_GatesDocReadPreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "admin acp correctly gates doc read operation (setup before aac), allow if authorized, otherwise error",
