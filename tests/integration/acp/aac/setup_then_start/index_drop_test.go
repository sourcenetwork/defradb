...
func TestAAC_GatesIndexDropPreSetup_AllowIfAuthorizedElseError(t *testing.T) {
	test := testUtils.TestCase{
		Description: "admin acp correctly gates index drop operation (setup before aac), allow if authorized, otherwise error",
