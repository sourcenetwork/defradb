...
compliant resources. But as long as the Remote DAC backend deems them to be valid they are allowed
...
but are Vera-compatible, it might be worthwhile to look at the documented tests and notes there:
