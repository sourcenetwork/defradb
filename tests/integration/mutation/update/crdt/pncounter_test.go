...
func TestPNCounterUpdate_IntKindWithPositiveIncrement_ShouldIncrement(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Int field accumulates two positive increments correctly.",
...
func TestPNCounterUpdate_IntKindWithPositiveIncrementOverflow_RollsOverToMinInt64(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Int field rolls over to MinInt64 when Int64 maximum is exceeded.",
		// Accumulated CRDT fields (pncounter/pcounter) cannot be indexed.
		// https://github.com/sourcenetwork/defradb/issues/4439
		MultiplierExcludes: []string{multiplier.SecondaryIndex},
...
func TestPNCounterUpdate_FloatKindWithPositiveIncrement_ShouldIncrement(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Float field accumulates two positive increments correctly.",
		// Accumulated CRDT fields (pncounter/pcounter) cannot be indexed.
		// https://github.com/sourcenetwork/defradb/issues/4439
		MultiplierExcludes: []string{multiplier.SecondaryIndex},
		Actions: []any{
...
func TestPNCounterUpdate_Float32KindWithPositiveIncrement_ShouldIncrement(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Float32 field accumulates two positive increments correctly.",
		// Accumulated CRDT fields (pncounter/pcounter) cannot be indexed.
		// https://github.com/sourcenetwork/defradb/issues/4439
		MultiplierExcludes: []string{multiplier.SecondaryIndex},
		Actions: []any{
...
func TestPNCounterUpdate_Float64KindWithPositiveIncrement_ShouldIncrement(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Float64 field accumulates two positive increments correctly.",
		// Accumulated CRDT fields (pncounter/pcounter) cannot be indexed.
		// https://github.com/sourcenetwork/defradb/issues/4439
		MultiplierExcludes: []string{multiplier.SecondaryIndex},
		Actions: []any{
...
func TestPNCounterUpdate_FloatKindWithPositiveIncrementOverflow_PositiveInf(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Float field positive overflow beyond MaxFloat64 yields positive infinity.",
		// Accumulated CRDT fields (pncounter/pcounter) cannot be indexed.
		// https://github.com/sourcenetwork/defradb/issues/4439
		MultiplierExcludes: []string{multiplier.SecondaryIndex},
...
func TestPNCounterUpdate_FloatKindWithDecrementOverflow_NegativeInf(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Float field negative overflow beyond -MaxFloat64 yields negative infinity.",
		// Accumulated CRDT fields (pncounter/pcounter) cannot be indexed.
		// https://github.com/sourcenetwork/defradb/issues/4439
		MultiplierExcludes: []string{multiplier.SecondaryIndex},
		SupportedClientTypes: immutable.Some(
...
func TestPNCounterUpdate_FloatKindWithPositiveIncrementInsignificantValue_DoesNothing(t *testing.T) {
	test := testUtils.TestCase{
		Description: "PNCounter Float field ignores an increment too small to affect a near-MaxFloat64 value.",
		// Accumulated CRDT fields (pncounter/pcounter) cannot be indexed.
		// https://github.com/sourcenetwork/defradb/issues/4439
		MultiplierExcludes: []string{multiplier.SecondaryIndex},
		Actions: []any{
