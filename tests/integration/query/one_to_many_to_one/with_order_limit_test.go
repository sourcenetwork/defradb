...
// Following panics, also pretty sure this will also panic for one-to-one-to-one case, todo fix in #833.
// Panic is related to when planner tries to compare (guessing comparison with a nil value)
