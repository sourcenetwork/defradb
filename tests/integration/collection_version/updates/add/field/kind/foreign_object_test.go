...
func TestSchemaUpdatesAddFieldKindForeignObject_RelationBetweenTwoExistingCollections(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			&action.AddSchema{
				Schema: `
...
func TestSchemaUpdatesAddFieldKindForeignObject_OneToManyRelationBetweenTwoExistingCollections(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			&action.AddSchema{
				Schema: `
