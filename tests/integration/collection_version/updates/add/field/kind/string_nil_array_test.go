...
func TestSchemaUpdatesAddFieldKindNillableStringArrayWithAdd(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			&action.AddSchema{
				Schema: `
...
func TestSchemaUpdatesAddFieldKindNillableStringArraySubstitutionWithAdd(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			&action.AddSchema{
				Schema: `
