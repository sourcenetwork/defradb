...
func TestOneToOneUniqueIndex_OnPrimarySide_AutoCreated(t *testing.T) {
...
func TestOneToOneUniqueIndex_CompositeIndexRelationNotFirst_AutoIndexStillCreated(t *testing.T) {
...
func TestOneToOneUniqueIndex_OneToMany_ShouldNotCreateIndex(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			&action.AddSchema{
				Schema: `
