...
func TestBackupExport_DoubleReletionship_NoError(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			...
			testUtils.ExportBackup{
				ExpectedContent: `{"User":[{"_docID":"{{.DocID0_0}}","_docIDNew":"bae-1552bcf5-6b3b-5cd0-bdaf-33bb43f74ab4","age":31,"name":"John"},{"_docID":"{{.DocID0_1}}","_docIDNew":"bae-be327e0b-a7fa-53ce-b29a-919cce5b5120","age":31,"name":"Bob"}],"Book":[{"_authorID":"bae-1552bcf5-6b3b-5cd0-bdaf-33bb43f74ab4","_docID":"{{.DocID1_0}}","_docIDNew":"bae-041e43b9-93dd-5884-8075-f35b42f827ed","_favouriteID":"bae-be327e0b-a7fa-53ce-b29a-919cce5b5120","name":"John and the sourcerers' stone"}]}`,
			},
		},
	}
...
func TestBackupExport_DoubleReletionshipWithUpdate_NoError(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			...
			testUtils.ExportBackup{
				ExpectedContent: `{"User":[{"_docID":"{{.DocID0_0}}","_docIDNew":"bae-1552bcf5-6b3b-5cd0-bdaf-33bb43f74ab4","age":31,"name":"John"},{"_docID":"{{.DocID0_1}}","_docIDNew":"bae-be327e0b-a7fa-53ce-b29a-919cce5b5120","age":31,"name":"Bob"}],"Book":[{"_authorID":"bae-1552bcf5-6b3b-5cd0-bdaf-33bb43f74ab4","_docID":"{{.DocID1_0}}","_docIDNew":"bae-041e43b9-93dd-5884-8075-f35b42f827ed","_favouriteID":"bae-be327e0b-a7fa-53ce-b29a-919cce5b5120","name":"John and the sourcerers' stone"},{"_docID":"{{.DocID1_1}}","_docIDNew":"bae-01e3546b-088f-5da6-b345-25cb5858f90b","name":"Game of chains"}]}`,
			},
		},
	}
