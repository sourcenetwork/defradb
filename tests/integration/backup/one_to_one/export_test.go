...
func TestBackupExport_DoubleReletionship_NoError(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			...
			testUtils.ExportBackup{
				ExpectedContent: `{"User":[{"_docID":"{{.DocID0_0}}","_docIDNew":"{{.DocID0_0}}","age":31,"name":"John"},{"_docID":"{{.DocID0_1}}","_docIDNew":"{{.DocID0_1}}","age":31,"name":"Bob"}],"Book":[{"_authorID":"{{.DocID0_0}}","_docID":"{{.DocID1_0}}","_docIDNew":"{{.DocID1_0}}","_favouriteID":"{{.DocID0_1}}","name":"John and the sourcerers' stone"}]}`,
			},
		},
	}
...
func TestBackupExport_DoubleReletionshipWithUpdate_NoError(t *testing.T) {
	test := testUtils.TestCase{
		Actions: []any{
			...
			testUtils.ExportBackup{
				ExpectedContent: `{"User":[{"_docID":"{{.DocID0_0}}","_docIDNew":"{{.DocID0_0}}","age":31,"name":"John"},{"_docID":"{{.DocID0_1}}","_docIDNew":"{{.DocID0_1}}","age":31,"name":"Bob"}],"Book":[{"_authorID":"{{.DocID0_0}}","_docID":"{{.DocID1_0}}","_docIDNew":"{{.DocID1_0}}","_favouriteID":"{{.DocID0_1}}","name":"John and the sourcerers' stone"},{"_docID":"{{.DocID1_1}}","_docIDNew":"{{.DocID1_1}}","name":"Game of chains"}]}`,
			},
		},
	}
