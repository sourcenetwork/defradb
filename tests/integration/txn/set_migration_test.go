...
// This test runs SetMigration inside of a transaction, and illustrates that not committing the transaction
// results in the migration not happening yet.
//
// Note that a test illustrating correct behavior WITH a commit already exists. See:
