...
TestReturnCode "${T1} 'chore: This is an valid title'" 0;
TestReturnCode "${T1} 'ci: This is an valid title'" 0;
TestReturnCode "${T1} 'docs: This is an valid title'" 0;
TestReturnCode "${T1} 'feat: This is an valid title'" 0;
TestReturnCode "${T1} 'fix: This is an valid title'" 0;
TestReturnCode "${T1} 'perf: This is an valid title'" 0;
TestReturnCode "${T1} 'refactor: This is an valid title'" 0;
TestReturnCode "${T1} 'test: This is an valid title'" 0;
TestReturnCode "${T1} 'tools: This is an valid title'" 0;
