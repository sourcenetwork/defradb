...
After successful deployment the API will be available on port 80. You will need to use the ingress URI for your deployment (example: http://e5ma9cph8pe05ee2va3e9ai9hg.ingress.hurricane.akash.pub/).